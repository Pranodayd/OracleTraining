...
public class SimpleSeleniumScript {
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		if(StyleValue.equals("display: none;"))
			...
			System.out.println("HIDE BUTTON does not work fine.Style attribute did not changed correctly");
	
		ShowButton.click();
		Thread.sleep(5000);
		StyleValue=TxtElement.getAttribute("style");
		if(StyleValue.equals("display: block;"))
			System.out.println("SHOW BUTTON works fine.Style attribute changed correctly");
		else
			System.out.println("SHOW BUTTON does not work fine.Style attribute did not changed correctly");
		D.close();
	}
